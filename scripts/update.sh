...
LOCAL_LIST="comet.js mediafusion.js stremthru.js zilean.js debridio.js jackettio.js knightcrawler.js torbox-search.js torrentio-plus.js bitsearch.js dmm-hashlist.js au-longtail.js jackett-bridge.js netflix-deeplink.js deeplink-any.js"
